...
public class Client extends JFrame implements ActionListener {
    ...
    ContactsDAO dao; // Extra Source Code 호출
    ...
    public void insert() {
        ...
        if (name.equals("")) {
            JOptionPane.showMessageDialog(null, "추가할 Tuple의 이름 ?");
        } else {
            Person person = new Person(name, phone, email);
            dao.insert(person);
            JOptionPane.showMessageDialog(null, "Tuple이 저장되었습니다.");
        }
        clear();
    }
    ...
    public void delete() {
        name = jtfName.getText();
        if (name.equals("")) {
            JOptionPane.showMessageDialog(null, "삭제할 Tuple의 이름은 ?");
        } else {
    ...
    public void update() {
        ...
        JOptionPane.showMessageDialog(null, name + "Tuple이 Update 되었습니다.");
        clear();
    }
    ...
    public void search() {
        ...
        recordNumber = 0;
        if (name.equals("")) {
            JOptionPane.showMessageDialog(null, "탐색할 Tuple의 이름은 ?");
        } else {
            list = dao.search(name);
            if (list.size() == 0) {
                JOptionPane.showMessageDialog(null, "Tuple이 없습니다");
                clear();
            } else {
    ...
    public void next() {
        ...
        if (recordNumber >= list.size()) {
            JOptionPane.showMessageDialog(null, "탐색한 Tuple의 끝입니다");
    ...
    public void previous() {
        ...
        if (recordNumber < 0) {
            JOptionPane.showMessageDialog(null, "탐색한 Tuple의 시작입니다");
